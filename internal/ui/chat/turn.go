...
func (s state) isSurface() bool {
	switch s {
	case stateFocus, stateDiffFull, statePreview, stateReview, stateContext, stateRewindPick, statePick, stateTodoPropose, stateTodoPause, stateModelList, stateUndoConfirm, stateKeyEntry, statePressure:
		return true
	}
	return false
}
