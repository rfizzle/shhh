...
func (s state) isSurface() bool {
	switch s {
	case stateFocus, stateDiffFull, statePicture, stateReview, stateContext, stateRewindPick, statePick, stateModelList, stateUndoConfirm, stateKeyEntry, statePressure:
		return true
	}
	return false
}
