...
| `/ui verbosity <v>` | Activity feed density: `low` shows step headers only, `normal` folds read-only runs into a counted row, `high` expands every row |
